...
export default {
    hosts: {
        domain: 'jitsi.sec-dojo.com',

        muc: 'conference.'+subdomain+'jitsi.sec-dojo.com', // FIXME: use XEP-0030
        focus: 'focus.jitsi.sec-dojo.com',
    },
    serviceUrl: 'wss://jitsi.sec-dojo.com/xmpp-websocket',
    ...
    externalConnectUrl: 'https://jitsi.sec-dojo.com/http-pre-bind',
    analytics: {
    ...
    useTurnUdp: false,
    websocket: 'wss://jitsi.sec-dojo.com/xmpp-websocket', // FIXME: use xep-0156 for that
    ...
    hiddenDomain: 'recorder.jitsi.sec-dojo.com',
    dropbox: {
